...
<html xmlns="http://www.w3.org/1999/xhtml"
    ...
    <body>
<div id="wb_Form1" style="position:absolute;left:64px;top:29px;width:1237px;height:658px;z-index:83;">
<form name="Form1" method="post" enctype="text/plain" id="Form1">
<input type="submit" id="Button1" name="btnAceptar" value="REGISTRAR" style="position:absolute;left:1095px;top:527px;width:124px;height:69px;z-index:38;">
<div id="wb_Form2" style="position:absolute;left:25px;top:50px;width:1054px;height:245px;z-index:39;">
...
<div id="wb_Text17" style="position:absolute;left:759px;top:186px;width:77px;height:16px;z-index:17;text-align:left;">
<span style="color:#000000;font-family:Arial;font-size:13px;">Subir Foto</span></div>
<marquee direction="down" scrolldelay="90" scrollamount="6" behavior="scroll" loop="0" style="position:absolute;left:842px;top:40px;width:100px;height:117px;z-index:18;" id="Marquee1"><span style="color:#DC143C;font-family:Arial;font-size:13px;">SUBE UNA FOTO!</span></marquee>
<input type="file" id="FileUpload1" style="position:absolute;left:840px;top:179px;width:196px;height:20px;z-index:19;" name="FileUpload1">
</form>
</div>
<div id="wb_Text1" style="position:absolute;left:27px;top:27px;width:119px;height:16px;z-index:40;text-align:left;">
<span style="color:#000000;font-family:Arial;font-size:13px;">Datos Personales:</span></div>
<div id="wb_Form3" style="position:absolute;left:29px;top:363px;width:592px;height:238px;z-index:41;">
<form name="Form3" method="post"  enctype="text/plain" id="Form3">
<div id="wb_Text11" style="position:absolute;left:15px;top:53px;width:118px;height:16px;z-index:20;text-align:left;">
<span style="color:#000000;font-family:Arial;font-size:13px;">Estado Civil:</span></div>
<select name="Combobox4" size="1" id="Combobox4" style="position:absolute;left:142px;top:51px;width:96px;height:21px;z-index:21;">
</select>
<div id="wb_Text12" style="position:absolute;left:42px;top:91px;width:55px;height:16px;z-index:22;text-align:left;">
<span style="color:#000000;font-family:Arial;font-size:13px;">Region:</span></div>
<div id="wb_Text13" style="position:absolute;left:30px;top:127px;width:75px;height:16px;z-index:23;text-align:left;">
<span style="color:#000000;font-family:Arial;font-size:13px;">Provincia:</span></div>
<div id="wb_Text14" style="position:absolute;left:41px;top:160px;width:55px;height:16px;z-index:24;text-align:left;">
<span style="color:#000000;font-family:Arial;font-size:13px;">Distrito:</span></div>
<select name="Combobox5" size="1" id="Combobox5" style="position:absolute;left:143px;top:89px;width:96px;height:21px;z-index:25;">
</select>
<select name="Combobox6" size="1" id="Combobox6" style="position:absolute;left:142px;top:123px;width:96px;height:21px;z-index:26;">
</select>
<select name="Combobox7" size="1" id="Combobox7" style="position:absolute;left:143px;top:159px;width:96px;height:21px;z-index:27;">
</select>
<div id="wb_Text15" style="position:absolute;left:27px;top:195px;width:65px;height:16px;z-index:28;text-align:left;">
<span style="color:#000000;font-family:Arial;font-size:13px;">Direccion:</span></div>
<input type="text" id="Editbox5" style="position:absolute;left:141px;top:195px;width:398px;height:19px;line-height:19px;z-index:29;" name="Editbox5" value="">
<div id="wb_Text16" style="position:absolute;left:22px;top:22px;width:89px;height:16px;z-index:30;text-align:left;">
<span style="color:#000000;font-family:Arial;font-size:13px;">Ocupacion:</span></div>
<select name="Combobox8" size="1" id="Combobox8" style="position:absolute;left:142px;top:16px;width:167px;height:21px;z-index:31;">
</select>
</form>
</div>
<div id="wb_Text10" style="position:absolute;left:36px;top:333px;width:119px;height:16px;z-index:42;text-align:left;">
<span style="color:#000000;font-family:Arial;font-size:13px;">Otros Datos:</span></div>
<div id="wb_Form4" style="position:absolute;left:652px;top:362px;width:423px;height:234px;z-index:43;">
<form name="Form4" method="post" enctype="text/plain" id="Form4">
<div id="wb_Text19" style="position:absolute;left:11px;top:17px;width:67px;height:16px;z-index:32;text-align:left;">
<span style="color:#000000;font-family:Arial;font-size:13px;">Correo:</span></div>
<div id="wb_Text20" style="position:absolute;left:11px;top:55px;width:67px;height:16px;z-index:33;text-align:left;">
<span style="color:#000000;font-family:Arial;font-size:13px;">Telefono:</span></div>
<div id="wb_Text21" style="position:absolute;left:14px;top:91px;width:67px;height:16px;z-index:34;text-align:left;">
<span style="color:#000000;font-family:Arial;font-size:13px;">Celular:</span></div>
<input type="text" id="Editbox6" style="position:absolute;left:93px;top:15px;width:179px;height:18px;line-height:18px;z-index:35;" name="Editbox6" value="">
<input type="text" id="Editbox7" style="position:absolute;left:94px;top:91px;width:179px;height:18px;line-height:18px;z-index:36;" name="Editbox6" value="">
<input type="text" id="Editbox8" style="position:absolute;left:94px;top:54px;width:179px;height:18px;line-height:18px;z-index:37;" name="Editbox6" value="">
</form>
</div>
<div id="wb_Text18" style="position:absolute;left:652px;top:340px;width:250px;height:16px;z-index:44;text-align:left;">
